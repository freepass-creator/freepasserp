...
const INFO_COLS = [
  ...
  { key: 'maker',         label: '제조사',   align: 'l', filterable: true, w: 80 },
  { key: 'model',         label: '모델명',   align: 'l', filterable: true, w: 100 },
  { key: 'subModel',      label: '세부모델', filterable: true, w: 200, align: 'l' },
  { key: 'trim',          label: '세부트림', searchable: true, w: 140, align: 'l' },
  { key: 'options',       label: '선택옵션', searchable: true, w: 160, align: 'l' },
  { key: 'fuel',          label: '연료',     align: 'c', filterable: true, w: 80 },
  { key: 'color',         label: '색상',     align: 'c', filterable: true, w: 100 },
  { key: 'year',          label: '연식',     align: 'c', filterable: true, w: 75 },
  { key: 'mileage',       label: '주행거리', num: true,  filterable: true, w: 105 },
  { key: 'vehicleClass',  label: '차종구분', align: 'c', filterable: true, w: 100 },
  { key: 'reviewStatus',  label: '심사기준', align: 'c', filterable: true, w: 100 },
