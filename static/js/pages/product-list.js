...
const INFO_COLS = [
  ...
  { key: 'vehicleStatus', label: '차량상태', align: 'c', filterable: true },
  { key: 'productType',   label: '상품구분', align: 'c', filterable: true },
  ...
  { key: 'subModel',      label: '세부모델', filterable: true },
  { key: 'trim',          label: '세부트림', searchable: true },
  { key: 'options',       label: '선택옵션', searchable: true },
  { key: 'fuel',          label: '연료',     align: 'c', filterable: true },
  { key: 'color',         label: '색상',     align: 'c', filterable: true },
  { key: 'year',          label: '연식',     align: 'c', filterable: true },
  { key: 'mileage',       label: '주행거리', num: true,  filterable: true },
