...
function renderTabBar() {
  ...
  // 필터 버튼 (탭이 아닌 버튼, CSS로 페이지별 표시 제어)
  html += `<button class="mobile-tab mobile-tab--filter" id="mobile-filter-btn" type="button" aria-label="필터">
    ${icon('filter')}
    <span class="mobile-tab__label">필터</span>
  </button>`;
