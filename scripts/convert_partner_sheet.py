...
SUB_FIX = {
    # ─── K5 ───
    'K5': 'K5 DL3 19~', 'K5 3세대': 'K5 DL3 19~',
    '더 뉴 K5 3세대': '더 뉴 K5 DL3 (페리) 23~',
    '더 뉴 K5  3세대': '더 뉴 K5 DL3 (페리) 23~',
    '더뉴 K5 - 3세대': '더 뉴 K5 DL3 (페리) 23~',
    '더 뉴 K5 GSL': '더 뉴 K5 DL3 (페리) 23~',
    '더 뉴 K5 HEV': '더 뉴 K5 DL3 (페리) 23~',
    '기아 K5 DL3': 'K5 DL3 19~',
    # K3
    '더 뉴 K3 2세대': '더 뉴 K3 BD (페리) 21~',
    'K3 1.6': 'K3 BD 18~',
    # K8
    'K8': 'K8 GL3 21~', '더 뉴 K8': '더 뉴 K8 GL3 (페리) 24~',
    '더 뉴 k8': '더 뉴 K8 GL3 (페리) 24~',
    '더 뉴K8 HEV': '더 뉴 K8 GL3 (페리) 24~',
    # K9
    'K9': 'K9 RJ 18~',
    '더 뉴 K9 2세대': '더 뉴 K9 RJ (페리) 21~',
    # ─── 셀토스 ───
    '셀토스': '셀토스 SP2 19~',
    '디 올 뉴 셀토스': '더 뉴 셀토스 SP2 (페리) 22~',
    '더 뉴 셀토스': '더 뉴 셀토스 SP2 (페리) 22~',
    '더뉴셀토스': '더 뉴 셀토스 SP2 (페리) 22~',
    # ─── 쏘렌토 ───
    '쏘렌토': '쏘렌토 MQ4 20~',
    '쏘렌토 MQ4': '쏘렌토 MQ4 20~',
    '쏘렌토4세대': '쏘렌토 MQ4 20~',
    '쏘렌토 2.5T': '쏘렌토 MQ4 20~',
    '쏘렌토 2.5 그래비티 2WD 5인승': '쏘렌토 MQ4 20~',
    '쏘렌토 2.5 프레스티지 5인승': '쏘렌토 MQ4 20~',
    '더 뉴 쏘렌토': '더 뉴 쏘렌토 MQ4 (페리) 23~',
    '더 뉴 쏘렌토4세대': '더 뉴 쏘렌토 MQ4 (페리) 23~',
    '더 2026 쏘렌토': '더 뉴 쏘렌토 MQ4 (페리) 23~',
    # ─── 카니발 ───
    '카니발': '카니발 KA4 20~', '카니발 4세대': '카니발 KA4 20~',
    '카니발 2.2D 프레스티지 9인승': '카니발 KA4 20~',
    '카니발 3.5T 9인승': '카니발 KA4 20~',
    '카니발 3.5 9인승 시그니처': '카니발 KA4 20~',
    '올 뉴 카니발': '카니발 KA4 20~',
    '올뉴카니발': '카니발 KA4 20~',
    'KA4 카니발': '카니발 KA4 20~',
    '더 뉴 카니발': '더 뉴 카니발 KA4 (페리) 23~',
    '더 뉴 카니발 3.5 가솔린 9인승': '더 뉴 카니발 KA4 (페리) 23~',
    '더 뉴 카니발 4세대 하이리무진': '더 뉴 카니발 KA4 (페리) 23~',
    '더 뉴 카니발 하이리무진': '더 뉴 카니발 KA4 (페리) 23~',
    '더 뉴 카니발 KA4 하이리무진 (페리)': '더 뉴 카니발 KA4 (페리) 23~',
    '더 뉴카니발 9인승 디젤 럭셔리': '더 뉴 카니발 KA4 (페리) 23~',
    'CN더뉴카니발하이리무진(특장)': '더 뉴 카니발 KA4 (페리) 23~',
    '하이리무진 2.2디젤': '더 뉴 카니발 KA4 (페리) 23~',
    # ─── 그랜저 ───
    '그랜저': '그랜저 GN7 22~', '그랜저 GN7': '그랜저 GN7 22~',
    '그랜저GN7': '그랜저 GN7 22~', '그랜져GN7': '그랜저 GN7 22~',
    '그랜져 GN7': '그랜저 GN7 22~',
    '그랜저 GN7 3.5 LPI 2WD': '그랜저 GN7 22~',
    '그랜저 2.5T 프리미엄 2WD': '그랜저 GN7 22~',
    '그랜저 IG': '그랜저 IG 16~', '그랜저IG': '그랜저 IG 16~',
    '그랜져IG': '그랜저 IG 16~',
    '더 뉴 그랜저IG': '더 뉴 그랜저 IG (페리) 19~',
    '디 올 뉴 그랜저GN7': '그랜저 GN7 22~',
    '더뉴그랜져': '더 뉴 그랜저 IG (페리) 19~',
    # ─── 쏘나타 ───
    '쏘나타 DN8': '쏘나타 DN8 19~', '쏘나타DN8': '쏘나타 DN8 19~',
    '쏘나타 디 엣지': '쏘나타 디 엣지 DN8 (페리) 23~',
    '쏘나타 디엣지': '쏘나타 디 엣지 DN8 (페리) 23~',
    '쏘나타디엣지': '쏘나타 디 엣지 DN8 (페리) 23~',
    '쏘나타 DN8 디 엣지 (페리)': '쏘나타 디 엣지 DN8 (페리) 23~',
    '디 엣지': '쏘나타 디 엣지 DN8 (페리) 23~',
    '소나타 디엣지': '쏘나타 디 엣지 DN8 (페리) 23~',
    '소나타 DN8': '쏘나타 DN8 19~',
    # ─── 아반떼 ───
    '아반떼': '아반떼 CN7 20~', '아반떼 CN7': '아반떼 CN7 20~',
    '아반떼CN7': '아반떼 CN7 20~',
    '아반떼 CN7 (페리)': '더 뉴 아반떼 CN7 (페리) 23~',
    '더 뉴 아반떼': '더 뉴 아반떼 CN7 (페리) 23~',
    '더 뉴 아반떼 CN7 (페리)': '더 뉴 아반떼 CN7 (페리) 23~',
    '아반데': '아반떼 CN7 20~',
    '아반떼 PE  N라인': '더 뉴 아반떼 CN7 (페리) 23~',
    '아반떼 PE N라인': '더 뉴 아반떼 CN7 (페리) 23~',
    '아반떼 CN7 1.6 LPG': '아반떼 CN7 20~',
    # ─── 싼타페 ───
    '싼타페TM': '싼타페 TM 18~',
    '싼타페': '싼타페 MX5 23~',
    '더 뉴 싼타페': '싼타페 MX5 23~',
    '싼타페 R2.2': '싼타페 TM 18~',
    '싼타페 2.5 프레스티지 5인승': '싼타페 MX5 23~',
    '싼타페MX5': '싼타페 MX5 23~',
    # ─── 팰리세이드 ───
    '팰리세이드': '팰리세이드 LX2 18~',
    '팰리세이드 LX2': '팰리세이드 LX2 18~',
    '더 뉴 팰리세이드': '더 뉴 팰리세이드 LX2 (페리) 22~',
    '더 뉴 팰리세이드 LX2 (페리)': '더 뉴 팰리세이드 LX2 (페리) 22~',
    '더뉴팰리세이드': '더 뉴 팰리세이드 LX2 (페리) 22~',
    '더 올뉴 팰리세이드': '팰리세이드 LX3 25~',
    '디 올 뉴 팰리세이드': '팰리세이드 LX3 25~',
    '디 올뉴팰리세이드': '팰리세이드 LX3 25~',
    '팰리세이드 3.8 AWD': '팰리세이드 LX2 18~',
    # ─── 스포티지 ───
    '스포티지': '스포티지 NQ5 21~',
    '더 뉴 스포티지': '더 뉴 스포티지 NQ5 (페리) 24~',
    '스포티지5세대': '스포티지 NQ5 21~',
    '스포티지 1.6T': '스포티지 NQ5 21~',
    '디 올뉴스포티지': '스포티지 NQ5 21~',
    # ─── 모닝 ───
    '모닝': '모닝 JA 17~',
    '더 뉴 모닝': '더 뉴 기아 모닝 JA (페리2) 23~',
    '더뉴 모닝 1.0 프레스티지': '더 뉴 기아 모닝 JA (페리2) 23~',
    # ─── 레이 ───
    '레이': '레이 TAM 11~',
    '더 뉴 레이': '더 뉴 기아 레이 TAM (페리2) 22~',
    '더 뉴 기아 레이': '더 뉴 기아 레이 TAM (페리2) 22~',
    # ─── 캐스퍼 ───
    '캐스퍼': '캐스퍼 AX1 21~', '캐스퍼(CASPER)': '캐스퍼 AX1 21~',
    # ─── 코나 ───
    '코나': '코나 SX2 23~',
    # ─── 스타리아 ───
    '스타리아': '스타리아 US4 21~',
    '스타리아 9인승': '스타리아 US4 21~',
    '스타리아 투어러': '스타리아 US4 21~',
    '스타리아 투어러 US4': '스타리아 US4 21~',
    # ─── 투싼 ───
    '투싼 (신형)': '더 뉴 투싼 NX4 (페리) 23~',
    'NX4': '투싼 NX4 20~',
    '더 뉴 투싼': '더 뉴 투싼 NX4 (페리) 23~',
    '투싼 1.6 N라인 인스퍼레이션 2WD': '투싼 NX4 20~',
    # ─── 르노 ───
    '아르카나': '아르카나 LJB 24~',
    '아르카나 1.6 GTe': '아르카나 LJB 24~',
    'ARKANA': '아르카나 LJB 24~',
    'SM6': 'SM6 LFD 16~',
    'QM6': 'QM6 HZG 16~',
    'QM6 LPe': 'QM6 HZG 16~',
    '더 뉴 QM6': 'QM6 HZG 16~',
    'XM3': 'XM3 LJB 20~',
    '그랑 콜레오스': '그랑 콜레오스 OV6 24~',
    '그랑 콜레오스 OV6': '그랑 콜레오스 OV6 24~',
    'E-Tecos 하이브리드': '그랑 콜레오스 OV6 24~',
    'KOLEOS': 'QM6 HZG 16~',
    # ─── 테슬라 ───
    '모델Y': '모델 Y 21~', '모델Y 프리미엄': '모델 Y 21~',
    '모델3 롱레인지': '모델 3 19~',
    'Model 3 Premium Long Range RWD': '모델 3 19~',
    'Model Y Premium RWD': '모델 Y 21~',
    # ─── G80 / GV80 / G70 / G90 ───
    'G80': 'G80 RG3 20~', 'G80 RG3': 'G80 RG3 20~',
    'G80 2.5T AWD': 'G80 RG3 20~',
    'G80 3.5T 2WD': 'G80 RG3 20~',
    '더뉴 G80 (RG3)': '더 뉴 G80 RG3 (페리) 23~',
    '더 올뉴G80': 'G80 RG3 20~',
    'GV80': 'GV80 JX1 20~',
    'GV80 2.5T AWD': 'GV80 JX1 20~',
    'GV80 2.5T AWD 5인승': 'GV80 JX1 20~',
    'GV80 3.0D AWD 5인승': 'GV80 JX1 20~',
    'GV80 3.5T AWD 7인승': 'GV80 JX1 20~',
    'G70': 'G70 IK 17~',
    'G90': 'G90 RS4 21~',
    'EQ900': 'G90 HI 15~',
    'DH 3.3 Premium AWD': 'G80 DH 페리 16~',
    # ─── KGM ───
    '액티언': '더 뉴 액티언 J120 24~',
    '더 뉴 티볼리': '티볼리 X100 15~',
    # ─── BMW ───
    'BMW 320i': '3시리즈 G20 페리 (LCI) 22~',
    '3시리즈(7세대) 320i LCI 2': '3시리즈 G20 페리 (LCI) 22~',
    'X3 G01': 'X3 G01 17~',
    'BMW X3 M40i': 'X3 G01 페리 (LCI) 21~',
    'X5 (G05)': 'X5 G05 19~',
    '4시리즈 (F32)': '4시리즈 F32 13~',
    '4시리즈': '4시리즈 G22 20~',
    # ─── 벤츠 — sub에 트림 정보 있는 케이스 모두 처리 ───
    'GLC X254': 'GLC X254 23~',
    'GLC 쿠페 X254': 'GLC X254 23~',
    'GLE V167 페리 (페리)': 'GLE V167 페리 (페리) 23~',
    'GLE 쿠페 C167': 'GLE V167 페리 (페리) 23~',
    'E200': '더 뉴 E-클래스 W213 (페리) 20~',
    'E220d': '더 뉴 E-클래스 W213 (페리) 20~',
    'E450': 'E-클래스 W214 24~',
    'E220 W213': '더 뉴 E-클래스 W213 (페리) 20~',
    'E450 W214': 'E-클래스 W214 24~',
    'Mercedes-Benz E200': '더 뉴 E-클래스 W213 (페리) 20~',
    'Mercedes-Benz E220d 4MATIC': '더 뉴 E-클래스 W213 (페리) 20~',
    'Mercedes-Benz GLC300 4MATIC': 'GLC X254 23~',
    'Mercedes-Benz GLC300 4MATIC Coupe': 'GLC X254 23~',
    'GLC300 X254': 'GLC X254 23~',
    'GLE450d C236': 'GLE V167 페리 (페리) 23~',
    'Mercedes-Benz GLE450d 4MATIC Coupe': 'GLE V167 페리 (페리) 23~',
    # ─── 기아 K5 / EV6 / X1 / X4 / 트랙스 (짧은 sub 보강) ───
    'K5 DL3': 'K5 DL3 19~',
    'EV6': 'EV6 CV 21~',
    'X1 F48': 'X1 F48 15~',
    'X4 2.0D M Sport': 'X4 G02 18~',
    '트랙스 1.2 E-터보 엑티브 플러스': '트랙스 9BQC 23~',
    # ─── 아우디 A6 (sub가 트림인 케이스) ───
    'A6 40 TDI': 'A6 C8 19~',
    'A6 45 TFSI Quattro': 'A6 C8 19~',
    'A6 45 TFSI': 'A6 C8 19~',
    'A6 C8': 'A6 C8 19~',
    '35TDi 2.0 디젤': 'A6 C8 19~',
    # ─── 기아 K7 (단종, 31건) ───
    'K7': '올 뉴 K7 YG 16~',
    '올 뉴 K7': '올 뉴 K7 YG 16~',
    'K7프리미어': 'K7 프리미어 YG (페리) 19~',
    'K7 프리미어': 'K7 프리미어 YG (페리) 19~',
    # ─── 기아 모하비 ───
    '모하비': '더 마스터 모하비 HM (페리) 19~',
    '모하비 3.0 4WD 6인승': '더 마스터 모하비 HM (페리) 19~',
    '모하비 3.0D 마스터스 그래비티 4WD 6인승': '더 마스터 모하비 HM (페리) 19~',
    '모하비 더 마스터': '더 마스터 모하비 HM (페리) 19~',
    # ─── 쉐보레 스파크 ───
    '스파크': '스파크 M400 15~',
    '스파크1.0': '스파크 M400 15~',
    '더뉴스파크': '더 뉴 스파크 M400 (페리) 18~',
    '더 넥스트 스파크': '스파크 M400 15~',
    # ─── 벤츠 S-클래스 / GLS / CLE / EQS / AMG GT / G-클래스 / A-클래스 ───
    'S350d W223': 'S-클래스 W223 20~',
    'S400d': 'S-클래스 W223 20~',
    'S450 W222': 'S-클래스 W222 13~',
    'S500': 'S-클래스 W223 20~',
    'S560 W222': 'S-클래스 W222 13~',
    'S580': 'S-클래스 W223 20~',
    'S 350d 4MATIC': 'S-클래스 W223 20~',
    'Mercedes-Benz S350d': 'S-클래스 W223 20~',
    'Mercedes-Benz S400d 4MATIC': 'S-클래스 W223 20~',
    'Mercedes-Benz S500 4MATIC': 'S-클래스 W223 20~',
    'Mercedes-Benz S580 4MATIC': 'S-클래스 W223 20~',
    'GLS400d C257': 'GLS X167 19~',
    'GLS580': 'GLS X167 19~',
    'Mercedes-Benz GLS580 4MATIC': 'GLS X167 19~',
    'CLE200카브리올레': 'CLE 카브리올레 A236 24~',
    'CLE 카브리올레 A236': 'CLE 카브리올레 A236 24~',
    'EQS350': 'EQS V297 21~',
    'Mercedes-Benz EQS350': 'EQS V297 21~',
    'AMG GT': 'AMG GT 15~',
    'G63 AMG': 'G-클래스 W463 18~',
    'Mercedes-AMG G63': 'G-클래스 W463 18~',
    'A45 AMG 4MATIC': 'A-클래스 W177 18~',
    # ─── 아우디 A3/A4/A5/A7/A8/Q3/Q5/Q7/Q8 ───
    'A3 8Y': 'A3 8Y 20~',
    'A3 40 TFSI': 'A3 8Y 20~',
    'A4 B9': 'A4 B9 15~',
    'A4 40 TFSI': 'A4 B9 15~',
    'A5 (F5)': 'A5 F5 16~',
    'A5 Sportback 40 TFSI quattro': 'A5 F5 16~',
    'A7 45 TDI quattro': 'A7 C8 18~',
    'A8 D5': 'A8 D5 17~',
    'A8 L 55 TFSI Quattro': 'A8 D5 17~',
    'Q3 35 TDI': 'Q3 F3 18~',
    'Q5 FY': 'Q5 FY 17~',
    'Q5 45 TFSI Quattro': 'Q5 FY 17~',
    'Q7 45 TDI Quattro': 'Q7 4M 15~',
    'Q8 45 TDI Quattro': 'Q8 4M 18~',
    # ─── BMW Z4 / M4 ───
    'Z4(G29)': 'Z4 G29 18~',
    'Z4 G29': 'Z4 G29 18~',
    'M4 컨버터블': 'M4 G82 20~',
    'M4 G82': 'M4 G82 20~',
    # ─── 현대 스타렉스 ───
    '그랜드 스타렉스': '그랜드 스타렉스 TQ 07~',
    '더 뉴 그랜드 스타렉스': '그랜드 스타렉스 TQ 07~',
    # ─── 기타 (마스터에 없음 — 그대로) ───
}
...
# ─── CAR_MODELS 로드 (sub → maker/model 역추출용) ──────
def load_car_models():
    """car-models.js 파일에서 entry 파싱"""
    import os
    path = os.path.join(os.path.dirname(__file__), '..', 'static', 'js', 'data', 'car-models.js')
    with open(path, encoding='utf-8') as f:
        src = f.read()
    entries = []
    pat = re.compile(r"\{\s*maker:\s*'([^']+)',\s*model:\s*'([^']+)',\s*sub:\s*'([^']+)'")
    for m in pat.finditer(src):
        entries.append({'maker': m.group(1), 'model': m.group(2), 'sub': m.group(3)})
    return entries

CAR_MODELS = load_car_models()
SUB_TO_MM = {e['sub']: (e['maker'], e['model']) for e in CAR_MODELS}
print(f'[init] CAR_MODELS 로드: {len(CAR_MODELS)} entries')
...
for gid, tab, partner in target:
    try:
        ...
        for r in data_rows:
            ...
            # ⚡ sub가 마스터에 있으면 그 sub의 maker/model을 우선 사용 (오타·잘못 입력 자동 보정)
            if sub_norm in SUB_TO_MM:
